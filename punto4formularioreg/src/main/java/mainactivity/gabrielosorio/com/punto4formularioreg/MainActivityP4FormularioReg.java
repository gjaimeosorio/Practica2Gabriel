package mainactivity.gabrielosorio.com.punto4formularioreg;
...
public class MainActivityP4FormularioReg extends AppCompatActivity {
    String sexo;
    static String fecha="";
    String ciudad;
    String hobbies;
    ...
    public MainActivityP4FormularioReg()
    {
        sexo="";
        ciudad="";
        hobbies="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_p4_formulario_reg);
...
// Apply the adapter to the spinner
    ...
    public void verificar_hobbies(){
        if(((CheckBox)findViewById(R.id.tenis)).isChecked())
        {
            hobbies+="Tenis ";

        }
        if(((CheckBox)findViewById(R.id.comer)).isChecked())
        {
            hobbies+="Salir a comer ";

        }
        if(((CheckBox)findViewById(R.id.cine)).isChecked())
        {
            hobbies+="Ir a cine";

        }
        if(((CheckBox)findViewById(R.id.video)).isChecked())
        {
            hobbies+="Videojuegos";
